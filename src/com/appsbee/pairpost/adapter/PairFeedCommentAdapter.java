...
public class PairFeedCommentAdapter extends ArrayAdapter<Comments>{
	...
	public PairFeedCommentAdapter(ListPairFeedAdapter listPairFeedAdapter,String user_id,String post_id,Activity activity, int textViewResourceId,	ArrayList<Comments> items) {
