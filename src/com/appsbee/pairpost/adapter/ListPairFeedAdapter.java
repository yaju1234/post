...
public class ListPairFeedAdapter extends ArrayAdapter<Discoder> {
    ...
    public void commentDlg( final String post_id,final String totalcomment) {
  	...
  	PairFeedCommentAdapter listCommentAdapter = new PairFeedCommentAdapter(ListPairFeedAdapter.this,Constant.userId,post_id,activity,R.layout.row_comments,mCommentArr);
