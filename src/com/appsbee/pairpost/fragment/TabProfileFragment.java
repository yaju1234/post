...
public class TabProfileFragment extends Fragment implements OnPageChangeListener, OnClickListener,InnerTabFollowingListener,InnerTabFollowersListener{
	...
	private class GetUserDataAsyncTask extends AsyncTask<Void, Void, String>{
		...
		protected String doInBackground(Void... params)	{
			...
			try{
				...
				param.put("member_id", userId);// other user pair_post_id
