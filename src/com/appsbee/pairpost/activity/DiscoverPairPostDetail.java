...
public class DiscoverPairPostDetail extends YouTubeBaseActivity implements OnClickListener, OnTouchListener{
    ...
    protected void onCreate(Bundle arg0) {
       ...
       // videoPlayer1.setOnTouchListener(this);
       // videoPlayer2.setOnTouchListener(this);
    }
...
public class LikeListAsyncTask extends    AsyncTask<String, Void, Boolean> {
    ...
    public void commentDlg(String user_id, String post_id,final String totalcomment) {
  	...
  	final TextView lbl_total_comments = (TextView)dlg_comments.findViewById(R.id.lbl_total_comments);
	...
	String comments="";
  	...
  	protected void onPostExecute(Boolean result) {
  	   ...
  	   if(result){
  	       for(int i=0; i<mCommentArr.size(); i++){
  		 System.out.println("!-- user info "+mCommentArr.get(i).getComment());
  	       }
